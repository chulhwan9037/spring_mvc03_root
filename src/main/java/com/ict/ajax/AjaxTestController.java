...
public class AjaxTestController {
	...
	// 반환형이 String 인 경우 문서타입이 contetnType="text/html" 타입으로 알아서 처리 됨
	...
	@ResponseBody
	public String Xml_Exam02() {       // tag로 이루어진 xml
	...
	@ResponseBody
	public String Xml_Exam03() {          // 속성으로 이루어진 xml
		
		 StringBuffer sb = new StringBuffer();
	        sb.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");      // \" => 쌍따옴표
	        sb.append("<products>");
	...
	@ResponseBody
	public String Xml_Exam04() {                  // 태그 속성 모두 포함된 xml 가장 흔한 패턴     
