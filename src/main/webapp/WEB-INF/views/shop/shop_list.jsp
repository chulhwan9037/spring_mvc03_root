        ...
        <tbody>
            <c:choose>
            	<c:when test="${empty shop_list}">
            		<tr>
            			<td colspan="5"><h3>제품 준비중 입니다.</h3></td>
            		</tr>
            	</c:when>
            	<c:otherwise>
            		<c:forEach var="k" items="${shop_list}" >
            			<tr>
            				<td>${k.p_num}</td>
            				<td><img src="resources/images/${k.p_image_s}" style="width: 100px"></td>
            				<td><a href="shop_detail.do?shop_idx=${k.shop_idx}">${k.p_name}</a></td>
