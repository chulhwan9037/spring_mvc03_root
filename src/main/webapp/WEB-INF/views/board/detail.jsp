...
<script type="text/javascript">
	...
	function ans_writer(f) {
		f.action="ans_writer.do";
		f.submit();
	}
...
<body>
		...
		<th bgcolor="#B2EBF4">첨부파일</th>
		 <td>
		 	<c:choose>
		 		...
		 		<c:otherwise>
		 			<td>
		 				<a href="down.do?f_name=${bovo.f_name}">
		 				<img src="resources/upload/${bovo.f_name}" style="width: 80px"></a>
		 			</td>
		 		</c:otherwise>
		 	</c:choose>
		 </td>
	...
	<tr>
     <td colspan="2">
        ...
        <input type="button" value="답글" onclick="ans_writer(this.form)" />
